...
private GrenadeLaucher grenadeLaucher;
        ...
        public void testConstructor() {
            ...
            CoordinatesWithRoom c5 = new CoordinatesWithRoom(1, 1, m.getMapUsed().getGameBoard().getRoom(1));
            ...
            m.getPlayers().get(4).getHand().add(new GrenadeLaucher());
            ...
            //TODO THEN CAN MOVE TARGET


            // IF I USE OP2 ON GREEN TARGET
            LinkedList<CoordinatesWithRoom> listTwo = new LinkedList<>();
            listTwo.add(list.get(4));
            temp.clear();
            temp = m.getPlayers().get(4).getHand().get(0).fromCellsToTargets(listTwo, c5, m.getMapUsed().getGameBoard(), m.getPlayers().get(4), m, enBase);
            for (Object o : targets) {
                System.out.println(o);
            }
