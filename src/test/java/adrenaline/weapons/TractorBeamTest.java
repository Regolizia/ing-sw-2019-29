...
import adrenaline.*;
import adrenaline.weapons.TractorBeam;
...
private TractorBeam tractorBeam;
        ...
        public void testConstructor() {
            ...
            CoordinatesWithRoom c4 = new CoordinatesWithRoom(1,1,m.getMapUsed().getGameBoard().getRoom(2));
            ...
            m.getPlayers().get(4).getHand().add(new TractorBeam());
            ...
            // I CHOOSE PURPLE TARGET, BASE EFFECT
            ...
            tractorBeam.canShootAlt();
            tractorBeam.canShootBase();
            tractorBeam.toString();
        }
