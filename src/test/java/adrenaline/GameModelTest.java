...
class GameModelTest {
    ...
    void constructor() {
        ...
        CoordinatesWithRoom c1 = new CoordinatesWithRoom(1,1,model.getMapUsed().getGameBoard().getRooms().get(0));
        ...
        model.getMapUsed().getGameBoard().getRoom(0).getAmmoTile(c1);
        model.getMapUsed().getGameBoard().getRoom(0).getAmmoTile(new CoordinatesWithRoom(1,1,model.getMapUsed().getGameBoard().getRooms().get(0)));
