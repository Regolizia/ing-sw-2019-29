...
/*         VirtualClientGUI clientGUI = new VirtualClientGUI();
            File file = clientGUI.getFileFromResources("C:" + File . separatorChar + "Users"+ File . separatorChar +"utente%20hp"
                    + File . separatorChar +"Documents"+ File . separatorChar +"Git"+ File . separatorChar +"ing-sw-2019-29"
